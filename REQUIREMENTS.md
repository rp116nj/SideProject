...
- [ ] Books may be associated with at most one campus. Likewise, Categories may be associated with many Books
...
- [ ] Write a route to serve up a single campus (based on its id), _including that Categories' Books_
- [ ] Write a route to serve up a single student (based on their id), _including that student's campus_

#### Frontend
- [ ] Write a component to display a single campus with the following information:
  - [ ] The campus's name, image, address and description
  - [ ] A list of the names of all Books in that campus (or a helpful message if it doesn't have any Books)
- [ ] Display the appropriate campus's info when the url matches `/Categories/:campusId`
- [ ] Clicking on a campus from the all-Categories view should navigate to show that campus in the single-campus view

- [ ] Write a component to display a single student with the following information:
  - [ ] The student's full name, email, image, and gpa
  - [ ] The name of their campus (or a helpful message if they don't have one)
- [ ] Display the appropriate student when the url matches `/Books/:studentId`
- [ ] Clicking on a student from the all-Books view should navigate to show that student in the single-student view
...
- [ ] Submitting the form with a valid name/address should:
  ...
  - [ ] Add the new campus to the list of Categories without needing to refresh the page
...
- [ ] Submitting the form with a valid first name/last name/email should:
  ...
  - [ ] Add the new student to the list of Books without needing to refresh the page
...
- [ ] In the all-Categories view, include an `X` button next to each campus
- [ ] Clicking the `X` button should:
  - [ ] Make an AJAX request that causes that campus to be removed from database
  - [ ] Remove the campus from the list of Categories without needing to refresh the page

- [ ] In the all-Books view, include an `X` button next to each student
- [ ] Clicking the `X` button should:
  - [ ] Make an AJAX request that causes that student to be removed from database
  - [ ] Remove the student from the list of Books without needing to refresh the page
